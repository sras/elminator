...
-- in a module named "Lib". Here is how you can implement a ToHType instance for this type so that your autogenerated
-- types can have fields of type `MyExtType a b`.
--
-- @
--
